    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "arrival_confirmed",
                    models.BooleanField(default=False, verbose_name="도착 확인"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "history_id",
                    models.AutoField(
                        primary_key=True, serialize=False, verbose_name="이력 ID"
                    ),
                ),
                (
                    "action",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(help_text="검사 상세 설명", verbose_name="검사 설명"),
                ),
                (
                    "department",
                    models.CharField(
                ...
                (
                    "duration",
                    models.IntegerField(help_text="분 단위", verbose_name="예상 소요 시간"),
                ),
                (
                    "is_active",
                    models.BooleanField(
                        default=True, help_text="검사 시행 가능한 검사 여부", verbose_name="활성 상태"
                    ),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "prep_id",
                    models.AutoField(
                        primary_key=True, serialize=False, verbose_name="준비사항 ID"
                    ),
                ),
                (
                    "title",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["exam", "is_required"], name="exam_prepar_exam_id_17dab8_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="appointmenthistory",
            index=models.Index(
                ...
                name="appointment_appoint_08501f_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="appointmenthistory",
        ...
        migrations.AddIndex(
            model_name="appointment",
            index=models.Index(
                fields=["user", "scheduled_at"], name="appointment_user_id_ed0db4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="appointment",
            index=models.Index(
                fields=["exam", "scheduled_at"], name="appointment_exam_id_8a2787_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="appointment",
            index=models.Index(
                fields=["status", "scheduled_at"], name="appointment_status_e303fa_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="appointment",
            index=models.Index(
                fields=["scheduled_at"], name="appointment_schedul_2da7be_idx"
            ),
        ),
    ]
